...
export const getPopularMoviesFailed = createAction('[GET Movie list] Popular Movies failed', (error: Error) => ({ error }));
...
export const getNowPlayingMoviesFailed = createAction('[GET Movie list] Now Playing Movies Failed', (error: Error) => ({ error }));

export const getTrending = createAction('[GET Trending]');
export const getTrendingSuccess = createAction('[GET Trending] Sucess', props<{ trending: any }>());
export const getTrendingFailed = createAction('[GET Trending] Failed',(error: Error) => ({ error }));